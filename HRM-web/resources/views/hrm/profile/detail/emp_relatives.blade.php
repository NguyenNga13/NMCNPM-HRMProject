        ...
        <tr id="relatives{{$relative->id}}">
          ...
          <td>
            <span class="docs-tooltip" data-toggle="tooltip" title="Xem thông tin chi tiết">
              ...
              <!-- <button class="btn btn-info btn-xs" data-toggle="modal" data-target="#modalViewRelatives" data-id_emp="{{convertIdEmp($emp->id)}}" data-name_emp="{{$emp->name}}" data-name="{{$relative->name}}" data-id="{{$relative->id}}" data-relationship="{{$relative->relationship}}" data-date_of_birth="{{$relative->date_of_birth}}" data-career="{{$relative->career}}" data-workplace="{{$relative->workplace}}" data-phone="{{$relative->phone}}" data-address="{{$addr->address}}" data-address_district="{{$addr->district}}" data-address_province="{{$addr->province}}"> <i class="fa fa-info-circle"></i></button> -->
            </span>
            <span class="docs-tooltip" data-toggle="tooltip" title="Xóa">
              <button class="btn btn-danger btn-xs btn-delete-relatives" value="{{$relative->id}}"><i class="fa fa-trash"></i></button>
            </span>
          </td>
        </tr>
        @endforeach
...
<!-- <div class="modal fade" id="modalConfirmDeleteRelatives" tabindex="-1" role="dialog" >
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <p>Bạn muốn xóa thành viên gia đình này?</p>
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-default" data-dismiss="modal">Cancel</button>
        <button class="btn btn-danger btn-confirm-delete" id="btn-confirm-delete-relatives">Delete</button> 
      </div>
    </div>
  </div>
</div> -->
