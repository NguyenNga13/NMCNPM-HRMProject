...
public class CommendedDetailActivity extends AppCompatActivity {

    String memCode;
    ArrayList<Commended> commendedList;
    ListView lvCommendedDetail;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_commended_detail);

        Bundle blGetAcc = getIntent().getBundleExtra("Account");
        memCode = blGetAcc.getString("memCode");
        lvCommendedDetail = (ListView)findViewById(R.id.lv_commended_detail);
    ...
    public class callWebservice extends AsyncTask<String, Integer, String> {
        ...
        protected void onPostExecute(String s) {
            ...
            try {
                ...
                CommendedAdapter adapter = new CommendedAdapter(CommendedDetailActivity.this, R.layout.layout_commended_item, commendedList);
                lvCommendedDetail.setAdapter(adapter);
